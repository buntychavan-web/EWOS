...
/** Named talent pool (e.g., HiPo pool, technical leadership pool). */
@Entity
@Table(name = "talent_pools")
@SQLDelete(sql = "UPDATE talent_pools SET deleted_at = NOW() WHERE id = ? AND version_no = ?")
@SQLRestriction("deleted_at IS NULL")
public class TalentPool extends AuditableEntity {
