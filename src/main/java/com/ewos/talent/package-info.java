/**
 * Talent (learning + performance) module.
 *
 * <p>Status: RESERVED. Reserved namespace per EWOS_MASTER_ARCHITECTURE_v1.0. Every module under
 * {@code com.ewos.<module>} follows the same internal layout:
 *
 * <ul>
