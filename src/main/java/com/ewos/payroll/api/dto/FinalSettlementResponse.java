...
public record FinalSettlementResponse(
        ...
        BigDecimal gratuityCalculatedAmount,
        boolean gratuityOverridden,
        String gratuityOverrideReason,
        boolean gratuityEligibilityWaived,
        String gratuityWaiverReason,
