...
public class ExitMapper {
    ...
    public ResignationResponse toResponse(Resignation r) {
        return new ResignationResponse(
                ...
                r.getBuyoutDays(),
                r.getBuyoutAmount(),
                r.getNoticeRecoveryAmount(),
                r.isNoticeWaived(),
                r.getNoticeWaiverReason(),
                r.getGardenLeaveStartDate(),
                r.getGardenLeaveEndDate(),
                r.getNoticeExtensionReason(),
                r.getEarlyReleaseReason(),
                r.getAcceptedAt(),
                r.getAcceptedBy(),
                r.getExitWorkflowInstanceId(),
                r.getSuccessorEmployeeId(),
                r.getStatus(),
                r.getActualLastDay(),
