...
@Schema(description = "Payload for creating a new user. Password is validated against the configured policy.")
public record CreateUserRequest(
        ...
        @Schema(example = "T3mp0rary!Pass", requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank String password,

        @Schema(description = "Role UUIDs to assign. Empty or null → no roles.")
        Set<UUID> roleIds,
