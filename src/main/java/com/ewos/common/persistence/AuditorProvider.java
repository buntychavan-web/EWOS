 ...
 *       happen for endpoints under {@code /api/**} because {@link com.ewos.security.SecurityConfig}
 *       requires authentication on every non-public path; it would only arise if a permit-all
 *       endpoint decided to persist a row.
