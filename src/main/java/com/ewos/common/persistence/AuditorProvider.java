...
/**
 * Resolves the current auditor (user UUID) from the Spring Security context. The JWT authentication
 * filter puts the user's UUID string into {@link Authentication#getName()}, so we parse it here.
