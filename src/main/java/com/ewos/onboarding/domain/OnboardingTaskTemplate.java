...
/** Reusable per-company onboarding-task template. */
@Entity
@Table(name = "onboarding_task_templates")
@SQLDelete(
        sql =
                "UPDATE onboarding_task_templates SET deleted_at = NOW()"
                        + " WHERE id = ? AND version_no = ?")
@SQLRestriction("deleted_at IS NULL")
public class OnboardingTaskTemplate extends AuditableEntity {
    ...
    private OnboardingTaskOwner defaultOwner = OnboardingTaskOwner.HR;
    ...
    public OnboardingTaskOwner getDefaultOwner() {
        return defaultOwner;
    }

    public void setDefaultOwner(OnboardingTaskOwner v) {
        this.defaultOwner = v;
    }
