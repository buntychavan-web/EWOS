 ...
 * entirely by reading each module's own existing state (Payroll's {@code PayrollRun}, the Workflow
 * Engine's instance for that run, Sprint 14.3's {@code DataExchangeRecord}, and Sprint 14.4's own
 * {@code IntegrationExecutionRecord}) — no new persistence, no cross-module writes.
 */
